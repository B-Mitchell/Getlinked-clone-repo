...
const Footer = () => {
    ...
    <footer className='w-[100%] bg-[#100B20] pt-[2rem]'>
      <section className='md:w-[80%] w-[80%] m-auto md:flex block md:justify-between md:m-auto'>
        ...
        <div className='md:w-[40%] md:pr-1'>
            <p className='text-[1.875rem] text-[#D434FE] font-bold'><span className='text-[#FFF]'>get</span>linked</p>
            <p >Getlinked Tech Hackathon is a technology innovation program established by a group of organizations with the aim of showcasing young and talented individuals in the field of technology
            </p>
            <p className='mt-[2rem] md:mb-0 mb-[2rem]'> <span className='border-r-2 border-[#D434FE] pr-[.6rem] mr-[.6rem]'>Terms of Use</span>Privacy Policy</p>
        </div>

          <div className='md:w-[30%] leading-8'>
          ...
          <div className='text-center md:mt-[2.19rem] mt-[1rem] flex'>
              <p className='text-[#D434FE] text-[1rem] font-normal'>Follow Us</p>
              <div className='flex w-[50%] justify-between ml-[.67rem]'>
                    {/* instagram */}
          ...
          <div className='md:w-[30%] md:mt-0 mt-[2rem]'>
            <p className='text-[#D434FE] font-bold '>Contact Us</p>
            <p className='flex py-2 text-center md:w-[50%] w-[35%] pr-1 justify-between'><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 12 12" fill="none">
  ...
  <path d="M9.3258 4.62279C9.50692 5.05949 9.6001 5.52763 9.6 6.00039H8.52C8.52008 5.66944 8.45495 5.34171 8.32834 5.03594C8.20172 4.73016 8.0161 4.45232 7.78208 4.21831C7.54807 3.98429 7.27023 3.79867 6.96446 3.67205C6.65868 3.54544 6.33095 3.48031 6 3.48039V2.40039C6.71199 2.40043 7.40798 2.61159 7.99997 3.00717C8.59195 3.40275 9.05334 3.96499 9.3258 4.62279Z" fill="#F8F8F8"/>
            ...
            <p className='flex py-2 text-center md:w-[50%] w-[35%] pr-1 justify-between'><svg xmlns="http://www.w3.org/2000/svg" width="13" height="15" viewBox="0 0 13 15" fill="none">
  <path d="M6.5 0C8.22391 0 9.87721 0.677294 11.0962 1.88289C12.3152 3.08848 13 4.72361 13 6.42857C13 9.09 10.9489 11.8786 6.93333 14.8571C6.80832 14.9499 6.65627 15 6.5 15C6.34373 15 6.19168 14.9499 6.06667 14.8571C2.05111 11.8786 0 9.09 0 6.42857C0 4.72361 0.684819 3.08848 1.90381 1.88289C3.12279 0.677294 4.77609 0 6.5 0ZM6.5 4.28571C5.92536 4.28571 5.37426 4.51148 4.96794 4.91334C4.56161 5.31521 4.33333 5.86025 4.33333 6.42857C4.33333 6.99689 4.56161 7.54194 4.96794 7.9438C5.37426 8.34566 5.92536 8.57143 6.5 8.57143C7.07464 8.57143 7.62574 8.34566 8.03206 7.9438C8.43839 7.54194 8.66667 6.99689 8.66667 6.42857C8.66667 5.86025 8.43839 5.31521 8.03206 4.91334C7.62574 4.51148 7.07464 4.28571 6.5 4.28571Z" fill="#F8F8F8"/>
            </svg>27,Alara Street <br />Yaba 100012 <br /> Lagos State</p>
          </div>
      </section>
      <p className='text-center pb-[1rem] md:mt-[1rem] mt-[3rem]'>All rights reserved. &copy; getlinked Ltd.</p>
