...
const Navbar = () => {
  ...
  return (
    <nav className='h-[4.3125rem] bg-[#150E28] flex justify-between  '>  
        ...
        <div className='md:flex md:justify-between sm:pt-[.5rem]  bg-[#150E28] '>
            ...
            <button className='h-[3.225rem] w-[10.75rem] mr-[3.5rem] rounded-[0.25rem] bg-gradient-to-r from-[#FF26B9] via-[#D434FE] to-[#903AFF] text-[1rem] hover:scale-[109%] transition md:block hidden' >Register</button>

            
            <svg className='mr-[3.5rem] sm:hidden mt-[1.7rem] hover:cursor-pointer hover:scale-[109%] transition' onClick={() => setIsOpen(true)} xmlns="http://www.w3.org/2000/svg" width="19" height="14" viewBox="0 0 19 14" fill="none">
...

        {
          ...
          <button className='h-[3.225rem] w-[10.75rem] rounded-[0.25rem] bg-gradient-to-r from-[#FF26B9] via-[#D434FE] to-[#903AFF] text-[1rem] hover:scale-[109%] transition mt-[2.81rem]' >Register</button>
        </div>
        : 
